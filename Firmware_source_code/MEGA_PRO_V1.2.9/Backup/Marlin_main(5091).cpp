...
static char temp=0;
 ...
 { 
   ...
   if(temp==2){enqueue_and_echo_commands_P(PSTR("G1 Z+20 E-10")); pauseCMDsendflag=false;temp=0;} //»ØËõÒ»ÏÂ
 }
}
/*
...
void print_next_mode()
{
 ...
 if(thermalManager.degBed()>40)
	...
	SERIAL_PROTOCOLLN("*2");
	do_blocking_move_to_xy(25, 10,1000/60);

	SERIAL_PROTOCOLLN("*4");

    do_blocking_move_to_xy(110, 200);
	SERIAL_PROTOCOLLN("*5");
	do_blocking_move_to_xy(110, 10,1000/60);
	SERIAL_PROTOCOLLN("*6");

    do_blocking_move_to_xy(180, 200);
	SERIAL_PROTOCOLLN("*7");
	do_blocking_move_to_xy(180, 10,1000/60);
