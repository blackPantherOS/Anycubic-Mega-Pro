                 ...
                 //        TFT_SERIAL_ENTER();
                       ...
                       if((!planner.movesplanned())&&(!TFTresumingflag))             
                         ...
                         if(TFTcode_seen('S'))//y������
                         {
						  ...
						  Laser_printer_st.pic_y_mirror = 1; //y����
						  				  
                         }
						  break;
						  case 44:
                          send_laser_param();//���ͼ����ӡ����
						  break;
  ...
  LOOP_XYZE(i) {
    if (code_seen(axis_codes[i]))
     { destination[i] = code_value_axis_units(i) + (axis_relative_modes[i] || relative_mode ? current_position[i] : 0);
	   if(i==2)destination[i]+=Z_OFFSET;//Zƫ��
     }
    else
...
void Laset_print_picture(void)
{
  ...
  if(Laser_printer_st.pic_vector==0)
	...
	if(Laser_printer_st.pic_x_mirror==1)
		{
		  x_start=110 + (Laser_printer_st.pic_widht * Laser_printer_st.pic_pixel_distance)/2;//X��ʼ����
		  x_end=110 - (Laser_printer_st.pic_widht * Laser_printer_st.pic_pixel_distance)/2;
		}
	else
		{
		 x_end =110 + (Laser_printer_st.pic_widht * Laser_printer_st.pic_pixel_distance)/2;//X��ʼ����
		 x_start =110 - (Laser_printer_st.pic_widht * Laser_printer_st.pic_pixel_distance)/2;
		}
	
	if(Laser_printer_st.pic_y_mirror==1)
		{
		  y_start=170 + (Laser_printer_st.pic_hight * Laser_printer_st.pic_pixel_distance)/2;//X��ʼ����
		  y_end  =170 - (Laser_printer_st.pic_hight * Laser_printer_st.pic_pixel_distance)/2;
		}
	else
		{
		 y_end =170 + (Laser_printer_st.pic_hight* Laser_printer_st.pic_pixel_distance)/2;//X��ʼ����
...
void print_next_mode()
{
 ...
 if(!planner.movesplanned())return;//����˶�û������ɣ��򷵻أ�����˶������ˣ��Ϳ���׼����һ����ӡ�ˡ�
...
void laser_init()
{
	...
	Laser_printer_st.pic_laser_time = 15;//��������ʱ�䣨10-30��
...
//  if((AssistLeveTestflag==1)&&(commands_in_queue < BUFSIZE)){ AssistLevelTest();}
  ...
  if(file_type==1&&card.sdprinting==true)
  	{
      prepare_laser_print();//����Ҫ������������ȹ��㣬���˶���Ԥ���߶ȣ�Ȼ��ſ�ʼ�����ӡ
    }
}
