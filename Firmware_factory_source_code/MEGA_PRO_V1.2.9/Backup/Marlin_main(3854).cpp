  ...
  switch (command_code) {
    ...
    case 'M': switch (codenum) {
      ...
      case 109: // M109: Wait for hotend temperature to reach target
       if(en_continue)//ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ó¡Ä£Ê½ï¿½Â£ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Â·ï¿½Ê½
	   	   gcode_M104();
	   else
        gcode_M109();
        break;
...
{
	char *starpos = NULL;
	 millis_t time_save  = 0;
	if(millis()<time_save)return;
	time_save = millis()+5000;//5ÃëÖ´ÐÐÒ»´Î
		

 if(!en_cycle_print )return ;
 if(!planner.movesplanned())return;//ï¿½ï¿½ï¿½ï¿½Ë¶ï¿½Ã»ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½É£ï¿½ï¿½ò·µ»Ø£ï¿½ï¿½ï¿½ï¿½ï¿½Ë¶ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ë£ï¿½ï¿½Í¿ï¿½ï¿½ï¿½×¼ï¿½ï¿½ï¿½ï¿½Ò»ï¿½ï¿½ï¿½ï¿½Ó¡ï¿½Ë¡ï¿?
 ...
 time_save += 5000;//Ôö¼Ó5Ãë
 SERIAL_PROTOCOLLN("*0");
 enqueue_and_echo_commands_P(PSTR("G1 Z10")); 
 SERIAL_PROTOCOLLN("*1");
 enqueue_and_echo_commands_P(PSTR("G1 Y10")); 
 SERIAL_PROTOCOLLN("*2");
...
void laser_init()
{
	...
	Laser_printer_st.pic_laser_time = 15;//¼¤¹âÕÕÉäÊ±¼ä£¨10-30£©
