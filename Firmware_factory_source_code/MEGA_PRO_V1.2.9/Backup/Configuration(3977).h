...
#define MSG_MY_VERSION "V1.2.8"//2020.4.17 带调平补偿
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // Ultimaker
  #define  DEFAULT_Kp 20//10//15.67
  #define  DEFAULT_Ki   1.0// 0.54// 0.94
  #define  DEFAULT_Kd 50.0//60.42//65.46
